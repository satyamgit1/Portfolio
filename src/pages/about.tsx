...
export default function About() {
  return (
    <>
      <NextSeo
        title="About Satyam Singh | React and Frontend Developer"
        description="Learn more about Satyam Singh, a dedicated React and Frontend Developer with 2 years of experience. Discover the journey, skills, and passion that drive me to create innovative and user-friendly web solutions."
        canonical={`${siteMetadata.siteUrl}/about`}
        openGraph={{
          url: `${siteMetadata.siteUrl}/about`,
          title: "Learn About Satyam Singh - React and Frontend Developer",
          description:
            "Dive into the story of Satyam Singh, a React and Frontend Developer. Uncover the experiences, skills, and passion that fuel a commitment to delivering exceptional web solutions.",
          images: [
            {
